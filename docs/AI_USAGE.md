# Registro de Uso de IA e Tokens

## Metodologia

O consumo de tokens foi registrado a partir do Codex na IDE, utilizando o comando `/status` ao final de cada etapa.

---

| Data | Etapa | Comando/Prompt | Input Tokens | Output Tokens | Total |
|---|---|---|---:|---:|---:|
